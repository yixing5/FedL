...
LastEditors: Sasha
LastEditTime: 2023-04-11 09:16:51
Description: 
FilePath: /FederatedLearning/FedL/federatedml/dnn/recommend _v4/mmoe_top_model.py
'''
import tensorflow as tf
import tensorflow.keras as keras
from tensorflow.keras import optimizers
from FedL.federatedml.dnn.backend.tensorflow.layers import MMoE
...
class MMoETopModel(BaseNNModel):
    ...
    def _build_model(self):
        ...
        self.model = MMoE(self.experts_units, self.experts_num)
