'''
Author: Sasha
Date: 2023-02-24 10:32:28
LastEditors: Sasha
LastEditTime: 2023-03-29 16:28:19
Description: 
FilePath: /FederatedLearning/FedL/service/service_host.py
'''
#%%
...
class DataTransferService(data_pb2_grpc.DataTransferServicer):
    ...
    def get_data(self, request,content):
        ...
        with feddb_host.db.begin(write=True) as db:
...
def serve():
    ...
    server.add_insecure_port('[::]:%s' % ServiceConf.port_host)
    server.start()
